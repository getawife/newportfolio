      ...
      <AnimatePresence>
        {hoveredProject?.previewUrl && (
          <motion.div
            ...
            className="fixed top-0 left-0 -translate-x-1/2 -translate-y-1/2 w-[480px] h-[280px] border border-[var(--border-system)] bg-[var(--bg-system)] shadow-2xl overflow-hidden rounded-lg"
          >
            <Image
